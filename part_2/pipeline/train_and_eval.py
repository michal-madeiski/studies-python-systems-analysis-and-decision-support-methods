...
df_cat_comp.to_csv("../comparison/csv_results/cat_comp.csv", index=False, float_format="%.3f")
df_num_comp.to_csv("../comparison/csv_results/num_comp.csv", index=False, float_format="%.3f")
#df_num_comp.to_csv("../comparison/csv_results/num_comp_poly.csv", index=False, float_format="%.3f")
df_cat_cv_comp.to_csv("../comparison/csv_results/cat_cv_comp.csv", index=False, float_format="%.3f")
df_num_cv_comp.to_csv("../comparison/csv_results/num_cv_comp.csv", index=False, float_format="%.3f")
#df_num_cv_comp.to_csv("../comparison/csv_results/num_cv_comp_poly.csv", index=False, float_format="%.3f")
df_cat_comp_train.to_csv("../comparison/csv_results/cat_comp_train.csv", index=False, float_format="%.3f")
df_num_comp_train.to_csv("../comparison/csv_results/num_comp_train.csv", index=False, float_format="%.3f")
#df_num_comp_train.to_csv("../comparison/csv_results/num_comp_train_poly.csv", index=False, float_format="%.3f")
df_cat_comp_diff.to_csv("../comparison/csv_results/cat_comp_diff.csv", index=False, float_format="%.3f")
df_num_comp_diff.to_csv("../comparison/csv_results/num_comp_diff.csv", index=False, float_format="%.3f")
#df_num_comp_diff.to_csv("../comparison/csv_results/num_comp_diff_poly.csv", index=False, float_format="%.3f")
df_num_comp_l1_l2.to_csv("../comparison/csv_results/num_comp_l1_l2.csv", index=False, float_format="%.3f")
df_cat_comp_oversampling.to_csv("../comparison/csv_results/cat_comp_oversampling.csv", index=False, float_format="%.3f")
df_cat_comp_undersampling.to_csv("../comparison/csv_results/cat_comp_undersampling.csv", index=False, float_format="%.3f")

df_num_comp_mse = pd.DataFrame(all_mse, columns=["target"] + [f"e{i+1}" for i in range(len(all_mse[0][1:]))])
df_num_comp_mse.to_csv("../comparison/csv_results/all_mse.csv", index=False, float_format="%.3f")
#df_num_comp_mse.to_csv("../comparison/csv_results/all_mse_poly.csv", index=False, float_format="%.3f")